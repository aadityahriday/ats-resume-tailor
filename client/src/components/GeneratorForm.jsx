    ...
    <section className="max-w-5xl mx-auto px-6 py-12" id="generator-form">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
        ...
        <div className="relative group">
          <label htmlFor="jd-textarea" className="flex items-center gap-2 mb-2.5">
          ...
          />
          <span className="absolute bottom-3 right-3 font-mono text-[10px] text-muted/40 tabular-nums">
        ...
        {/* Current Resume */}
        <div className="relative group">
          <label htmlFor="resume-textarea" className="flex items-center gap-2 mb-2.5">
          ...
          />
          <span className="absolute bottom-3 right-3 font-mono text-[10px] text-muted/40 tabular-nums">
            {currentResume.length.toLocaleString()} chars
          </span>
        </div>
      </div>
